/* ---------------------------------------------------------------------------
toneAC Library - v1.6.0 - 08/14/2023

AUTHOR/LICENSE:
Created by Tim Eckel - eckel.tim@gmail.com
Copyright 2023 License: GNU GPL v3 http://www.gnu.org/licenses/gpl-3.0.html

LINKS:
Project home: https://bitbucket.org/teckel12/arduino-toneac/wiki/Home
Support: https://bitbucket.org/teckel12/arduino-toneac/issues?status=new&status=open
...
08/14/2023 v1.6.0 - Added compatibility with ESP32.

04/27/2019 v1.5.0 - Made toneAC compatible with Arduino library manager.
